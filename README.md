...
HCCPE3monthDat = rename(HCCPE3monthDat, DEPLOYEDASIA= DEPLOYEDASIA___1, DEPLOYEDIRAQ=DEPLOYEDIRAQ___1, DEPLOYEDKOR= DEPLOYEDKOR___1, DEPLOYEDOTH=DEPLOYEDOTH___1, DEPLOYEDPERS=DEPLOYEDPERS___1, DEPLOYEDWWII=DEPLOYEDWWII___1, RESPECT_AGE=RESPECT_AGE___1, RESPECT_DISABLE=RESPECT_DISABLE___1, RESPECT_GENDER=RESPECT_GENDER___1, RESPECT_HIV=RESPECT_HIV___1, RESPECT_MH=RESPECT_MH___1, RESPECT_NONE=RESPECT_NONE___1, RESPECT_RACE=RESPECT_RACE___1,RESPECT_REL= RESPECT_REL___1, RESPECT_SEXPR=RESPECT_SEXPR___1)
...
write.csv(HCCPEDat, "HCCPEDat.csv", row.names = FALSE)
```
